...
g.  (2 points)  Now, let's get the exact answer for the question from part (e).  Type `table(labels_complete_2) / nrow(student)`.  What proportion of the observations are in the three groups being linked at the final iteration of hierarchical clustering?
