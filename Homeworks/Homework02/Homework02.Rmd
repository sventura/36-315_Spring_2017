...
c.  (4 points)  You can also specify HEX color values when choosing a color, e.g. `fill = "#4169E1"`.  Use a website like [this one](http://www.w3schools.com/colors/colors_picker.asp) to pick a color of your choice, and fill the bars with that color.
