...
ggplot(data = shark_1850, aes(x = Year, y = SharkLength)) +
  geom_point(aes(color = Fatal), alpha = 0.66) + xlim(1845, 2016) + 
  ...
  scale_color_manual(values = my_colors, 
                     labels = c("N" = "Not Fatal", "Y" = "Fatal", "UNKNOWN" = "Unknown")) +
  ...
  labs(x = "Year of Shark Attack", y = "Length of Shark (ft.)",
       ...
       subtitle = "Fatal Relationship in Black") + 
  my_theme
...
ggplot(data = shark_1850, aes(x = Year, y = Age)) +
  geom_point(aes(color = Sex), alpha = 0.66) + xlim(1845, 2016) + 
  geom_smooth(method = lm, color = "red", aes(fill = factor(1))) + 
  geom_smooth(data = filter(shark_1850, Sex == "F"), 
              method = lm, color = "black") + 
  scale_color_manual(name = "Gender of Victim", values = my_colors, 
                     labels = c("F" = "Female", "M" = "Male", "U" = "Unknown")) +
  scale_fill_manual(name = "Overall Relationship", values = "red", 
                    labels = "All Genders") + 
...
#  Adding 0.5 to the contingency table to help with estimation issues for missing months
...
sharks_subset1 <- mutate(shark_attacks, 
                    ...
                    day_of_week = factor(day_of_week, levels = c("Sunday", "Monday", 
                                                                 "Tuesday", "Wednesday", 
                                                                 "Thursday", "Friday", 
                                                                 "Saturday")))

shark_attacks$Fatal <- as.factor(shark_attacks$Fatal)
fatal_labels <- c("Y" = "Fatal", "N" = "Not Fatal", "UNKNOWN" = "Fatality Unknown", "(all)" = "All")
