...
It should be first mentioned that the article was probably proposed as a "neural" piece, and therefore one might assume no conclusion about the Wage gap was actually desired. In that case, they did a pretty good job of not saying anything :). 
...
In respect to the goal of expressing trivial that a wage gap exists they did a wonderful job. If they wanted to compare progress, question actions, look at other potential reasons for such gap and changes in the gap, they didn't do good job at all.

First, the data is all mixed together, with gender differences in wage and racial differences in wage being compared on the same plot. By including all the groups and the average in the same plot, it reduces the eye's ability to analysis the size of the differences. 

If I was to redo the graphic I would:
...
+ additionally I'd mark the "X" axes of these line plots with different presidual terms, and maybe even significant milestones outside the political sphere that might push changes in the wage gaps.
+ and lastly, if I wanted to get you questioning things, I might include subset by industry, or put additional historical trends that correlate with the fluctuations of the % differences, or compare other countries wage gaps of similar nations.
...
# Problem 6
Seeing if we can use you Labs solutions.