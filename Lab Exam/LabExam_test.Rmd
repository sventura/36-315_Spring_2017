...
f.  (BONUS:  3 points)  Your friend tells you that 4% of all movies are rated G, 15% are PG, 30% are PG-13, 43% are R, 0.25% are NC-17, and 7.5% of are N/A or Unrated.  Is there evidence to reject your friend's claim?  Provide visual or statistical evidence, and explain how this evidence leads you to your answer.
